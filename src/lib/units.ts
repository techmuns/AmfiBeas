...
/**
 * Format a percentage-point delta as basis points — always, at every magnitude
 * (e.g. +0.32 pp → "+32 bps", −4.3 pp → "−430 bps", +45.8 pp → "+4,580 bps").
 * Indian-grouped. Pass { sign: false } to drop the leading "+".
 */
