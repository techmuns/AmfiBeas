// Auto-generated static dataset: monthly sector net-flows (Rs bn).
// Transcribed from a provided research snapshot and validated against
// the report's Total row and CY26-YTD (= Jan–Apr 2026) sub-totals.
// Heatmap colouring is computed from these values at render time.
